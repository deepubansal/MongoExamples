...
public class MappingHelloWorldFreeMarkerStyle {
public static void main(String[] args) {
	Configuration config = new Configuration();
	config.setClassForTemplateLoading(MappingHelloWorldFreeMarkerStyle.class, "/");
	...
	try {
		...
		List<String> metadataList = Arrays.asList("Name","Gender","ID", "AGE", "Address");
